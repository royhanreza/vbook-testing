...
<head>
    ...
    <link href="{{ asset('room-booking/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css') }}" rel="stylesheet" type="text/css" />
    <!--end::Vendor Stylesheets-->
    <!--begin::Global Stylesheets Bundle(mandatory for all pages)-->
    <link href="{{ asset('room-booking/assets/plugins/global/plugins.bundle.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('room-booking/assets/css/style.bundle.css') }}" rel="stylesheet" type="text/css" />
...
<body id="kt_body" class="page-bg">
        ...
        <div class="page launcher sidebar-enabled d-flex flex-row flex-column-fluid me-lg-5" id="kt_page">
                                ...
                                <div class="card border-0 shadow-none min-h-200px" style="background-color: #D5D83D">
                                    ...
                                    <div class="card-body d-flex flex-center flex-wrap">
                                        ...
                                        <div class="d-flex flex-column align-items-center align-items-md-start flex-grow-1" data-theme="light">
                                            ...
                                            <!--end::List-->
                                            <!--begin::Link-->
                                            <a href="https://preview.keenthemes.com/html/metronic/docs" class="btn btn-hover-rise text-gray-900 text-uppercase fs-7 fw-bold" style="background-color: #EBEE51">Learn More</a>
                                            <!--end::Link-->
                                        </div>
                                        <!--end::Wrapper-->
                                    </div>
            ...
            <div id="kt_sidebar" class="sidebar px-5 py-5 py-lg-8 px-lg-11" data-kt-drawer="true" data-kt-drawer-name="sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="375px" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_sidebar_toggle">
                ...
                <div class="d-flex flex-stack mb-5 mb-lg-8" id="kt_sidebar_header">
                    <!--begin::Title-->
                    <h2 class="text-white">Today Booking</h2>
                    <!--end::Title-->
                    <!--begin::Menu-->
                    <div class="ms-1">
    ...
    <script src="{{ asset('room-booking/assets/plugins/global/plugins.bundle.js') }}"></script>
    <script src="{{ asset('room-booking/assets/js/scripts.bundle.js') }}"></script>
    <!--end::Global Javascript Bundle-->
    <!--begin::Vendors Javascript(used for this page only)-->

    <!--end::Vendors Javascript-->
    <!--begin::Custom Javascript(used for this page only)-->
    <script src="{{ asset('room-booking/assets/js/custom/utilities/modals/create-project/type.js') }}"></script>
    <script src="{{ asset('room-booking/assets/js/custom/utilities/modals/create-project/budget.js') }}"></script>
    <script src="{{ asset('room-booking/assets/js/custom/utilities/modals/create-project/settings.js') }}"></script>
    <script src="{{ asset('room-booking/assets/js/custom/utilities/modals/create-project/team.js') }}"></script>
    <script src="{{ asset('room-booking/assets/js/custom/utilities/modals/create-project/targets.js') }}"></script>
    <script src="{{ asset('room-booking/assets/js/custom/utilities/modals/create-project/files.js') }}"></script>
    <script src="{{ asset('room-booking/assets/js/custom/utilities/modals/create-project/complete.js') }}"></script>
    <script src="{{ asset('room-booking/assets/js/custom/utilities/modals/create-project/main.js') }}"></script>
    <script src="{{ asset('room-booking/assets/js/custom/utilities/modals/create-account.js') }}"></script>
