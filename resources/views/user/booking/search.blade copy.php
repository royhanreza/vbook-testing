            ...
            <div class="sticky-top mb-3">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Search by Filter</h3>
                    </div>
                    <div class="card-body">
                                            ...
                                            <div class="card-body">
                                                <form @submit.prevent="submitForm">
                                                    <div class="form-group mb-4">
                                                        <label for="" class="form-label">Projector</label>
                                                    ...
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <select name="" class="form-select" v-model="capacity">
                                                            <option value="">
                ...
                <div>
                    ...
                    <section class="content">
                        <div class="container">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <!-- <h3 class="card-title">Pilih Room</h3> -->
                                    <form @submit.prevent="submitSearch">
                                        <div class="form-group mb-4">
                                            <label for="" class="form-label"> Search Room</label>
                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="row col-12 mb-4">
                                            ...
                                            <div class="col-4 mb-2">
                                                <div class="card rounded me-2">
                                                    <img class="card-img-bottom" src="{{ asset('assets/booking-room/asset_all_new/room.png') }}" width="80px" alt="Card image cap">
                                                    <div class="card-body">
                                                        <div class="card-header text-center">
                                                            <span class="badge" style="background-color: {{ $room->color_code }}; border: 3px solid #000000; border-radius: 14px;">
                                                                <h5 class="card-title"> <b> {{ $room->name }} </b></h5>

                                                                &nbsp; &nbsp; <span class="badge badge-secondary"> Lantai : {{ $room->floor }}</span>
                                                            </span>
                                                        </div>
                                                    </div>
                                                    <table class="table text-center">
                                                        <tr class="text-center">
                                                            <td> <i class="fa-solid fa-tv fa-xs"></i></td>
                                                            <td> <i class="fa-solid fa-wifi fa-xs"></i></td>
                                                            <td> <i class="fa-solid fa-users fa-xs"></i></td>
                                                        </tr>
                                                        ...
                                                        <tr class="text-center">
                                                            ...
                                                            <td>
                                                                <span class="badge badge-pill badge-secondary">{{ $room->capacity }}</span>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <div class="card-body text-center">
                                                        <a href="/booking/{{ $room->id }}/create" class="card-link"><button class="btn btn-primary rounded-pill"> Pilih Ruangan</button></a>
                                                    </div>
                                                </div>
                                            </div>
                                            @endforeach
                                        ...
                                        @if($totalItem < 1 && request()->query('search'))
                                            <div class="col-xl-12 text-center">
                                                <img alt="Not found illustration" src="{{ asset('gambar/ICON RUN.png') }}" width="80px" />
                                                <br>
                                                <br>
                                                <span class="badge badge-pill badge-warning">
                                                    <h5> Oops!.. Hasil Pencarian untuk Room <span style="font-weight:bold;">{{ $req_search }}</span> tidak ditemukan.</h5>
                                                </span>
                                            </div>
                                            @endif
                                            <div class="mt-10">
