        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
            <div class="container-fluid">
                <ul class="nav justify-content-start ">
                    <li class="nav-item"><button class="btn" id="sidebarToggle"><i
                    ...
                    <li class="nav-item dropdown mr-2">
                        ...
                        <ul class="dropdown-menu " aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="index.html"><i
                                        class="fa-solid fa-door-open fa-lg"></i><br> Room</a>
                            </li>
                            <li><a class="dropdown-item" href="desk.html"><i class="fa-solid fa-wallet fa-lg"></i><br>
                                    Desk</a></li>
                            <li><a class="dropdown-item" href="#"><i class="fa-solid fa-car fa-lg"></i><br>Car</a></li>
                            <li><a class="dropdown-item" href="#"><i class="fa-solid fa-burger fa-lg"></i><br> Food</a>
                            </li>
                        </ul>
                    </li> --}}
                    ...
                    <div class="card1">
                        <div class="row p-5">
                            <div data-spy="scroll" class="col-md-8">
                                <div class="d-flex">
                                    <h3 class="ml-3"><span style="font-size: 3vw; color: black;">&#8226;</span> Kosong
                                    </h3>
                                    <h3 class="ml-3"><span style="font-size: 3vw; color: green;">&#8226;</span> Dipesan
                                    </h3>
                                    <h3 class="ml-3"><span style="font-size: 3vw; color: red;">&#8226;</span>
                                        Dipakai</h3>
                                </div>
                                <div id="carouselExampleInterval" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active" data-interval="10000">
                                            <a href="#" data-toggle="modal" data-id="1" data-target="#createEvent"
                                                class="open-DeskBooking"><img
                                                    src="{{ asset('assets/booking-room/asset_all_new/Map-lt3.png') }}"
                                                    style="width: 99%;"></a>
                                            <h2 class="text-center">Lantai 3</h2>
                                        </div>
                                        <div class="carousel-item" data-interval="2000">
                                            <a href="#" data-toggle="modal" data-id="2" data-target="#createEvent"
                                                class="open-DeskBooking"><img
                                                    src="{{ asset('assets/booking-room/asset_all_new/Map-lt4.png') }}"
                                                    style="width: 99%;"></a>
                                            <h2 class="text-center">Lantai 4</h2>
                                        </div>
                                        <div class="carousel-item">
                                            <a href="#" data-toggle="modal" data-id="3" data-target="#createEvent"
                                                class="open-DeskBooking"><img
                                                    src="{{ asset('assets/booking-room/asset_all_new/Map-lt5.png') }}"
                                                    style="width: 99%;"></a>
                                            <h2 class="text-center">Lantai 5</h2>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4 pt-3">
                                <div class="slideshow-container">
                                    ...
                                    <br>
                                    <h2 class="mb-4"><span class="mr-3"
                                            style="background-color: #BBD8FB; border-radius: 23px; padding: 5px;"><i
                                                class="fas fa-wifi"></i></span>
                                        Wifi</h2>
                                    <h2 class="mb-4"><span class="mr-3"
                                            style="background-color: #BBD8FB; border-radius: 23px; padding: 5px;"><i
                                                class="fas fa-restroom"></i></span> Toilet</h2>
                                    <h2 class="mb-4"><span class="mr-4"
                                            style="background-color: #BBD8FB; border-radius: 23px; padding: 5px;"><i
                                                class="fas fa-store"></i></span> Cafe</h2>
                                    <h2 class="mb-4"><span class="mr-3"
                                            style="background-color: #BBD8FB; border-radius: 23px; padding: 5px;"><i
                                                class="fas fa-smoking"></i></span> Smoking Area</h2>
                                    <h2 class="mb-4"><span class="mr-4 ml-2"
                                            style="background-color: #BBD8FB; border-radius: 23px; padding: 5px;"><i
                                                class="fas fa-bolt"></i></span> Listrik</h2>
                                    <h2 class="mb-4"><span class="mr-4"
                                            style="background-color: #BBD8FB; border-radius: 23px; padding: 5px;"><i
                                                class="fas fa-fan"></i></span> AC</h2>
                                </div>
                                <div id="next-meeting">
                        ...
                        <div class="modal-footer">
                            <div class="save-close-btn d-flex justify-content-end">
                                ...
                                <button data-url="{{ route('booking-room.store') }}" type="button" id="openCreateEvent"
                                    class="btn btn-dark" style="cursor: not-allowed;pointer-events: all !important;"
                                    disabled>
                                    Booking
                                </button>
                            </div>
                    ...
                    <div class="card1">
                        <div class="row">
                            <div data-spy="scroll" class="col-md-8">
                                ...
                                <div class="row" id="all_room_data">

                                    @foreach ($rooms as $key => $room)
                                    <div class="col-sm-6">
                                        <label class="label-room">
                                            <input type="radio" name="m_room_id" value="{{ $room->id }}" id="{{ $key }}"
                                                class="card-input-element m_room_id" / id="m_room_id">
                                                        ...
                                                        <div class="col-sm d-flex">
                                                            <ul class="check-list d-flex list-unstyled">
                                                                <li><i class="fa-solid fa-user fa-2xs"></i> <i
                                                                        class="fa-solid fa-2xs">{{ $room->kapasitas
                                                                        }}</i>
                                                                </li>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="{{ asset('assets/booking-room/asset_all_new/Map-lt3.png') }}" alt="" style="width: 100%">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                </div>
    ...
    {{-- <div class="modal fade bd-example-modal-lg" id="map" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content" style="background-color: #303030;">
                ...
                <div class="modal-body">
                    <img src="{{ asset('assets/booking-room/asset_all_new/Map.png') }}" alt="">
                </div>
            </div>
        </div>
    </div> --}}
    ...
    <div class="modal fade" id="createEvent" data-backdrop-limit="1" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="" method="POST" id="formData" class="row">
                    <div class="modal-body" style="padding:0">
                        ...
                        @csrf
                        <input type="hidden" name="m_room_id" id="m_room_id" value="">
                        ...
                        {{-- <a href="javascript:;"> --}}
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-md">
                                    ...
                                    <div class="mb-2 error-multiple-email-message d-none"
                                        style="font-size:13px;color:red">
                                        Please input valid email</div>

                                    <span class="text-danger error-text partisipans_error"
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".open-DeskBooking", function() {
            var myBookId = $(this).data('id');
            $(".modal-body #m_room_id").val(myBookId);
