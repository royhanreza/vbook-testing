...
<div id="app" v-cloak>
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-xxl" id="kt_content_container">
            ...
            <form @submit.prevent="submitForm" enctype="multipart/form-data" id="kt_ecommerce_add_product_form"
                class="form d-flex flex-column flex-lg-row"
                data-kt-redirect="../../demo4/dist/apps/ecommerce/catalog/products.html">
                <!--begin::Aside column-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <select class="form-select mb-2" v-model="deviceId">
                                ...
                                <option v-for="devices in device" :value="devices.id">@{{ devices.name }}</option>

                            </select>
                            <div class="text-muted fs-7"> Select the room device, if the data is empty, click<a href="#"
                                    data-bs-toggle="modal" data-bs-target="#kt_modal_1"> Create Device </a></div>
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-check mb-4">
                                            <input class="form-check-input" type="radio" name="flexRadioProjector"
                                                v-model="projector" value="1" id="flexRadioProjector">
                                            <label class="form-check-label" for="flexRadioProjector">
                                                Available
                                            </label>
                                        </div>
                                        <div class="form-check mb-4">
                                            <input class="form-check-input" type="radio" name="flexRadioProjector2"
                                                v-model="projector" value="2" id="flexRadioProjector2">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="text-muted fs-7 mb-4">Is internet available in the room &nbsp; <i
                                                class="bi bi-wifi"></i></div>

                                        <div class="form-check mb-4">
                                            <input class="form-check-input" type="radio" name="flexRadiointernet1"
                                                v-model="internet" value="1" id="flexRadiointernet1">
                                            <label class="form-check-label" for="flexRadiointernet1">
                                                Available
                                            </label>
                                        </div>
                                        <div class="form-check mb-4">
                                            <input class="form-check-input" type="radio" name="flexRadiointernet2"
                                                v-model="internet" value="2" id="flexRadiointernet2">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <div class="row col-lg-12">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" v-model="floor" class="form-control mb-2"
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" v-model="capacity" class="form-control mb-2"
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <div class="row col-lg-12">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="color" v-model="colorCode" id="color_code" class="form-control"
                                                placeholder="Color Code (code hex : #00000)">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" v-model="ipAddress" class="form-control mb-2"
                                                placeholder="ex : 192.168.xxx.xx" value="" />
                    ...
                    <div class="d-flex justify-content-end">
                        <!--begin::Button-->
                        <a href="/admin/manage-room" id="kt_ecommerce_add_product_cancel"
                            class="btn btn-secondary me-5">Cancel</a>
                        <!--end::Button-->
                        <!--begin::Button-->
                ...
                axios.post('/device', {
                    ...
                    .then(function(response) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                window.location.href = '/admin/manage-room/create';
                            }
                        })
                        // console.log(response);
                    })
