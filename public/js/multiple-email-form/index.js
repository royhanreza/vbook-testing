...
$(document).on('keypress','.multiple_emails-input',function(e) {
...
(function( $ ){
    $.fn.multiple_emails = function(options) {
        ...
        {
            deleteIconHTML = '<a href="#" class="multiple_emails-close" title="Remove"><span class="fa fa-times-circle"></span></a>';
        }
            ...
            */
            function display_email(t, dupEmailCheck) {
                ...
                for	(var i = 0; i < arr.length; i++) {
                    ...
                    if ( dupEmailCheck === true && $orig.val().indexOf(arr[i]) != -1 ) {
                        if (arr[i] && arr[i].length > 0) {
                           ...
                           $('.error-multiple-email-message').addClass('d-none');
                            new function () {
                ...
                if(errorEmails.length > 0){
                    ...
                    $('.error-multiple-email-message').removeClass('d-none');
                }else{
                    t.val("");
                    refresh_emails ();
                }
   ...
   //OR $('#example_emailBS').multiple_emails("Bootstrap");
       ...
       $('#email').text($('#example_emailBS').val());
